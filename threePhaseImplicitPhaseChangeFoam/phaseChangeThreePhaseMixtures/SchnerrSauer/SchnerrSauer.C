...
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::SchnerrSauer
(
...
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::rRb
(
...
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::alphaNuc() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::pCoeff
(
...
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField pCoeff(this->pCoeff(p));
...
void Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::correct()
{}


bool Foam::phaseChangeThreePhaseMixtures::SchnerrSauer::read()
{
