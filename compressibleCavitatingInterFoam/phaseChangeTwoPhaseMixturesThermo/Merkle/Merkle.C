...
namespace phaseChangeTwoPhaseMixturesThermo
{
    ...
    addToRunTimeSelectionTable(phaseChangeTwoPhaseMixtureThermo, Merkle, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::phaseChangeTwoPhaseMixturesThermo::Merkle::Merkle
(
...
Foam::phaseChangeTwoPhaseMixturesThermo::Merkle::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::phaseChangeTwoPhaseMixturesThermo::Merkle::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
...
void Foam::phaseChangeTwoPhaseMixturesThermo::Merkle::correct()
{}


bool Foam::phaseChangeTwoPhaseMixturesThermo::Merkle::read()
{
